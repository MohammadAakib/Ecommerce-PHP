<!-- footer -->
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids">
						...
						<ul>
							<li class="mb-3">
								<a href="product.php">Apple </a>
							</li>
							<li class="mb-3">
								<a href="product.php">TV</a>
							</li>
							<li class="mb-3">
								<a href="product.php">Android</a>
							</li>
                                                                                                                                                   <li class="mb-3">
								<a href="product.php">Macbook</a>
							</li>
                                                                                                                                                   <li class="mb-3">
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2020-2021 E-Commrece Store. All rights reserved | Design by Mohammad Aakib.
			</p>
		</div>
	</div>
	<!-- //copyright -->